...
const SectionContent = (props) => {
  ...
  const diskon = () => {
    let diskon = (parseInt(item.discon) / 100) * parseInt(item.price);
          ...
          <div className="w-full lg:basis-[66%] pl-3 lg:my-3 lg:mr-3 flex flex-col">
            <div className="">
              ...
              <div className="font-bold pt-7">
                ...
                <p className="text-sm text-orange-600">Rp {diskon()}.000</p>
              </div>
      ...
      <section className="pt-5">
        <div className="flex flex-col justify-center lg:flex-row gap-y-3">
          ...
          <div className="lg:basis-[75%]">
            {clickDesk == true && clickSpek == false && clickUlas == false ? (
              <div className="">
                ...
                {item.primacy != null && item.about == null ? (
                  <article className="pt-7 pl-3 lg:pl-5 pb-4 max-w-[23.4rem] sm:max-w-[26rem] lg:max-w-[40rem]">
                    <h5 className="text-lg font-base">Keunggulan Buku</h5>
                  ...
                  <article className="pt-7 pl-3 lg:pl-5 pb-4 max-w-[23.4rem] sm:max-w-[26rem] lg:max-w-[40rem]">
                    <h5 className="text-lg font-base">Tentang {item.author}</h5>
                    <p className="pt-4 pl-2 text-sm text-gray-700 lg:pl-5">
                      {item.about}
                    </p>
                  </article>
              ...
              <div>
                <div className="px-3 relative overflow-x-auto">
                  {item.specification.map((itm) => {
                    return (
                      <table className="w-full text-sm text-left" key={itm}>
                        <thead>
                          <tr>
                            <th
                              scope="col"
                        ...
                        <tbody>
                          ...
                          <tr className="bg-gray-100 border-b border-gray-600">
                            ...
                            <td className="px-3 py-2">{itm.weight} Gram</td>
                          </tr>
                          {itm.dimensi.map((i) => {
                            return (
                              <tr
                              ...
                              >
                                ...
                                <td className="px-3 py-2">
                                  {i.panjang} Cm/ {i.lebar} Cm/ {i.tinggi} Cm
                                </td>
                              </tr>
                            );
                          })}
                          ...
                          <tr className="bg-white">
                            ...
                            <td className="px-3 py-2">{itm.jenis_cover}</td>
                          </tr>
                        </tbody>
                      </table>
                    );
              ...
              <div>
                {item.ulasan == null ? (
                  <div className="px-3 max-w-auto">
                    <p className="text-sm font-bold">Belum Ada Review</p>
                  </div>
                ) : (
                  ""
                )}
